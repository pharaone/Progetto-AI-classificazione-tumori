...
"""
def calculate_confusion_matrix(y_test: pd.Series, y_pred: pd.Series) -> ndarray[tuple[int, int], dtype[any]]:
...
"""
def plot_save_confusion_matrix(confusion_matrix: ndarray[tuple[int, int], dtype[any]], output_path: str):
    classes = [4, 2]  # Define class labels (4 for malign and 2 for benign)
...
"""
def save_metrics_from_metrics_list(metrics_list: list[dict]):
